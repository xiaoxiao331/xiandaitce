    ...
    <header class="header">
        <nav class="navbar">
            <a class="navbar-brand" href="#">
                <span class="navbar-brand-logo"><img src="../img/logo_brand_new.png" alt="HYUNDAI MOTOR GROUP"></span>
                <span class="navbar-logo"><img src="../img/logo_tit_new.png" alt="工单事项管理系统"></span>
            </a>
