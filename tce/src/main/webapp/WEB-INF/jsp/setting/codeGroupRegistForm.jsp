...
$(function(){
  //등록 버튼
    $("#btnRegist").click(function() {
        ...
        $("#frm").attr('action',"/setting/codeGroupRegist.do");
        $("#frm").submit();
    });
                            ...
                            <table class="table tbl-typeA">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input id="groupCodeId" class="form-control" name="groupCodeId" value="" style="width:400px"></td>
                                    </tr>
                                    <tr>
                                        <th><span class="require">*</span><spring:message code="lbl.group.code_name"/></th>
                                        <td><input id="groupCodeNm" class="form-control" name="groupCodeNm" value="" style="width:400px"></td>
                                    </tr>
                                    <tr>
