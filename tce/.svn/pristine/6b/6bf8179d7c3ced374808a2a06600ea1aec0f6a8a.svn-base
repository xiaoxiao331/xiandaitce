...
public class GetContentTask  implements Callable<String>{
	...
	private static final Logger log = LoggerFactory.getLogger(GetContentTask.class);
    ...
    public GetContentTask(String serviceName,IMSService imsService,CarRetailInfoSearchVO carRetailInfoSearchVO){
