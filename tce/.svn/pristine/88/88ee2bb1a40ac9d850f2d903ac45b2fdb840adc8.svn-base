...
public class UtilAria {
    public static void main(String[] args) throws Exception{
        System.out.println(new String(Base64.decodeBase64("SDE5MDE0MTA=".getBytes("UTF-8")),"UTF-8"));
        System.out.println(new String(Base64.decodeBase64("MQ==".getBytes("UTF-8")),"UTF-8"));
    }
    public static String decrypt(String ciphertext, String passphrase) {
        try {
            ...
            UtilExceptionMessage.getExceptionDetailMsg(e);
        }
        return null;
    }
