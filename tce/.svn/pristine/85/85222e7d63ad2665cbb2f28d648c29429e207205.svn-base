...
public class ExcelRead {
    public static List<Map<String, String>> read(ExcelReadOption excelReadOption, InputStream fis) {
      //엑셀 파일 자체
        //엑셀파일을 읽어 들인다.
        //FileType.getWorkbook() <-- 파일의 확장자에 따라서 적절하게 가져온다.
        System.out.println("read :: " + excelReadOption.getFilePath());
        Workbook wb = ExcelFileType.getWorkbook(fis , excelReadOption.getFilePath());
        /**
